    ...
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-dark-400">Let's set up your security scanning platform</p>
        </div>
        ...
        <div className="flex items-center justify-center mb-8">
          {[1, 2, 3].map((s) => (
            <div key={s} className="flex items-center">
              ...
              {s < 3 && (
                <div className={`w-20 h-1 mx-2 ${step > s ? 'bg-primary-500' : 'bg-dark-700'}`} />
              )}
            </div>
          ))}
        </div>
        ...
        <div className="card p-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    <LinkIcon className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-dark-400" />
                    <input
                      type="url"
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  />
                  <p className="text-xs text-dark-400 mt-1">
                    Pipeline will be blocked if score falls below this threshold
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handlePolicyChange('maxCriticalVulns', parseInt(e.target.value))}
                      className="input w-full"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handlePolicyChange('maxHighVulns', parseInt(e.target.value))}
                      className="input w-full"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    />
                    <span className="text-dark-200">Block on Critical Vulnerabilities</span>
                  </label>
                  ...
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      className="w-5 h-5 rounded bg-dark-700 border-dark-600 text-primary-500 focus:ring-primary-500"
                    />
                    <span className="text-dark-200">Block on High Vulnerabilities</span>
                  </label>

                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={formData.policy.autoBlock}
                      onChange={(e) => handlePolicyChange('autoBlock', e.target.checked)}
                      className="w-5 h-5 rounded bg-dark-700 border-dark-600 text-primary-500 focus:ring-primary-500"
                    />
                    <span className="text-dark-200">Enable Auto-blocking</span>
                  </label>
                </div>
              </div>
            </div>
          ...
          {step === 3 && (
            <div className="space-y-6">
              ...
              <p className="text-dark-300 mb-6">
                Review your configuration and launch the initial security scan.
              </p>

              <div className="space-y-4">
                <div className="bg-dark-700/50 rounded-xl p-4">
                  <h3 className="text-sm font-medium text-dark-400 mb-2">Repository</h3>
                  <p className="text-white font-mono text-sm">{formData.repo_url}</p>
                  <p className="text-dark-400 text-sm mt-1">Branch: {formData.branch}</p>
                </div>

                <div className="bg-dark-700/50 rounded-xl p-4">
                  <h3 className="text-sm font-medium text-dark-400 mb-2">Security Policy</h3>
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div className="text-dark-300">Minimum Score:</div>
                    <div className="text-white">{formData.policy.minScore}</div>
                    <div className="text-dark-300">Max Critical:</div>
                    <div className="text-white">{formData.policy.maxCriticalVulns}</div>
                    <div className="text-dark-300">Max High:</div>
                    <div className="text-white">{formData.policy.maxHighVulns}</div>
                    <div className="text-dark-300">Block Critical:</div>
                    <div className="text-white">{formData.policy.blockCritical ? 'Yes' : 'No'}</div>
                    <div className="text-dark-300">Auto-block:</div>
                    <div className="text-white">{formData.policy.autoBlock ? 'Enabled' : 'Disabled'}</div>
                  </div>
                </div>
                ...
                <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-blue-300 font-medium">Initial Scan</p>
